...
# in compression pressent to user to place fali path if there is no sys.argv[1]
# use
...
# when you code does not have sideeffects, it is self-contained
# the benefit is you can make it perilized?
# shared resources create a bottleneck
# map gets a functionwith one input
